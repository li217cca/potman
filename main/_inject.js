...
function checkForBattleResults(raidId, nextDelay, retryCount, originalUrl) {
    ...
    var scheduleRetry = function (offset) {
        window.setTimeout(function () { checkForBattleResults(raidId, nextDelay + 650 + offset, retryCount + 1, originalUrl); }, nextDelay + offset);
    };
...
;
function __maybeShowViraButton() {
